...
<%@page import="app.labs.board.model.BoardCategory"%>
<%@page import="app.labs.board.service.IBoardCategoryService"%>
<%@page import="app.labs.board.service.BoardCategoryService"%>
